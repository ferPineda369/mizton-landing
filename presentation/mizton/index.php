...
<head>
    ...
    <link rel="stylesheet" href="../css/presentation.css?v=10">
    <link rel="stylesheet" href="styles-extra.css?v=10">
</head>
<body>
    ...
    <script src="../includes/presentation-common.js?v=10"></script>
