...
<head>
    ...
    <link rel="stylesheet" href="../css/presentation.css?v=16">
    <link rel="stylesheet" href="styles-extra.css?v=16">
</head>
<body>
    ...
    <script src="../includes/presentation-common.js?v=16"></script>
