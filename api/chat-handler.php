...
function handleFAQResponse($input) {
    ...
    $faqs = [
        ...
        // Seguridad
        'es seguro' => 'Absolutamente. Mizton garantiza la recuperación del 100% de tu compra inicial. Además, contamos con un sistema de respaldo sólido y transparente. Tu seguridad financiera es nuestra prioridad. 🛡️',
