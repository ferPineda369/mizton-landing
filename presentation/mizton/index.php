...
<head>
    ...
    <link rel="stylesheet" href="../css/presentation.css?v=14">
    <link rel="stylesheet" href="styles-extra.css?v=14">
</head>
<body>
    ...
    <script src="../includes/presentation-common.js?v=14"></script>
