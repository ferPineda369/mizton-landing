...
<head>
    ...
    <link rel="stylesheet" href="../css/presentation.css?v=15">
    <link rel="stylesheet" href="styles-extra.css?v=15">
</head>
<body>
    ...
    <script src="../includes/presentation-common.js?v=15"></script>
