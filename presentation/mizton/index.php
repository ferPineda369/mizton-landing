...
<head>
    ...
    <link rel="stylesheet" href="../css/presentation.css?v=11">
    <link rel="stylesheet" href="styles-extra.css?v=11">
</head>
<body>
    ...
    <script src="../includes/presentation-common.js?v=11"></script>
